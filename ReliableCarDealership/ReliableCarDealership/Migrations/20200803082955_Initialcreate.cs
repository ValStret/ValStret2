        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MakeModel = table.Column<string>(maxLength: 20, nullable: false),
                    Mileage = table.Column<int>(maxLength: 6, nullable: false),
                    Colour = table.Column<string>(maxLength: 10, nullable: false),
                    YearOfProduct = table.Column<int>(nullable: false),
