...
namespace ReliableCarDealership.Controllers
{
    public class PartsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PartId,Name,PartMakeModel,PartVehicleYear,PartPrice,Description,PartImage")] Part part)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PartId,Name,PartMakeModel,PartVehicleYear,PartPrice,Description,PartImage")] Part part)
        {
            if (id != part.PartId)
            {
                return NotFound();
